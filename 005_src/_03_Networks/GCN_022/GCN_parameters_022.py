...
input_columns = [
                        ...
                        #'data_classes',
                        'data_y_classes' # to be used for regression and test if the classification head actually helps
                        ]
...
output_columns = [
                        ...
                        #'data_y_delta',
                        #'data_y_yaw',
                        #'data_y_classes'# to be used for classification task
                        ]
shuttle_train = 36#70# 36#None # if none is set manually an appropriate one will be randomly chosen
shuttle_val = 50#76# 50#None
