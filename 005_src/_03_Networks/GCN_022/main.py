...
from _03_Networks.GCN_022.GCN_model_022 import *
from _03_Networks.GCN_022.GCN_trainer_022 import *
from _03_Networks.GCN_022.GCN_parameters_022 import *
from _03_Networks.GCN_022.Custom_losses import *
...
def main(
    ...
    show_columns = list(input_columns.copy())
    #show_columns.extend(["data_pos","data_classes"])
    print (df_input[show_columns])#.loc[7882])
    print (f"{dash*2}")
    pdb.set_trace()
    # PRINT====================================================================================
    ...
    if shuttle_train is None:
        printif ("selecting shuttle train", printstat)
    ...
    if shuttle_val is None:
        printif ("selecting shuttle validation", printstat)
        ...
        try: 
            ...
            shuttle_val =  random.choice(valid_frames)
    ...
    if num_hidden_layers == 1:
        ...
        # predict the classes of the target positions, classification
        if 'data_y_classes' in output_columns:
        ...
        # test that the correct classes actually help the GCN to learn
        elif 'data_y_classes' in input_columns:
            hc_1 = hidden_layers_sizes[0]

            model = HL01_bn_regress(
                                     num_input_features=size_input,
                                     num_output_features =size_output,
                                     random_seed = random_seed,
                                     hc_1 = hc_1,
        ...
        print( "error, too many layers given")
