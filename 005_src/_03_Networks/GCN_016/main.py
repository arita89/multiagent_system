...
from config import *
from _03_Networks.GCN_016.GCN_model_016 import *
from _03_Networks.GCN_016.GCN_trainer_016 import *
from _03_Networks.GCN_016.GCN_parameters_016 import *
...
def main(
    ...
    ## add information to the dict
    printif(f"\n{model=}",printstat)
    dict_text_output['conv_layer'] = model
    dict_text_output['activation_fun'] = activation_fun
