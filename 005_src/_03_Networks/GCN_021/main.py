...
from _03_Networks.GCN_021.GCN_model_021 import *
from _03_Networks.GCN_021.GCN_trainer_021 import *
from _03_Networks.GCN_021.GCN_parameters_021 import *
...
def main(
    ...
    if parse_data_stat: 
        ...
        #standard normalize the input
        #df_input_standard_normalized=standard_normalize_columns(df_input)
        #df_input=df_input_standard_normalized
        
        #graph normalize the input
        #df_input_standard_normalized_graph=standard_normalize_graph(df_input)
        #df_input=df_input_standard_normalized_graph

        #df_input_standard_normalized.to_csv(r'\old_stuff\OutputWithDelta_normalized_per_graph.csv')
