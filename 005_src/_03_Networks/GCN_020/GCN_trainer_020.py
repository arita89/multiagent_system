...
from _03_Networks.GCN_020.early_stop import EarlyStopping
    ...
    def run_trainer(self):
        ...
        for i in progressbar:
            ...
            if self.early_stopping and self.epoch > 1000:
                ...
                early_stopping_check = EarlyStopping(patience=100, 
                                                     #min_delta = 20,
    ...
    def _plot_results(self):
        ...
        if (shuttle_train is not None) and condition_plot:
            ...
            loss = plot_results_model(
                                       ...
                                       xlim = (xc-overview,xc+overview),
                                       ylim = (yc-overview,yc+overview),
            ...
            loss = plot_results_model(
                                       ...
                                       xlim = (xc-zoom,xc+zoom),
                                       ylim = (yc-zoom,yc+zoom),
