...
if __name__ == '__main__':
    ...
    kep = 1000
    knep = 1000
    type_load = "FINAL" #FINAL ; TRUNC :; TEMP
    ...
    shuttle_train = None #reloaded_dict["shuttle_train"]#,None # if none is set manually an appropriate one will be randomly chosen
    shuttle_val = None #reloaded_dict["shuttle_val"]#None

    print (f"{input_columns=}")
    print (f"{output_columns=}")
    print (f"{shuttle_train=}")
    print (f"{shuttle_val=}")
